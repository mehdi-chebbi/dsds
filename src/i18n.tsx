...
const en: Translations = {
  ...
  'answerQuestions.error.deleteFailed': 'Failed to delete answer',
  'answerQuestions.edit': 'Edit',
  'answerQuestions.delete': 'Delete',
  'answerQuestions.editAnswer': 'Edit Answer',
  'answerQuestions.updateAnswer': 'Update Answer',
  'answerQuestions.confirmDelete': 'Are you sure you want to delete this answer? This action cannot be undone.',
...
const fr: Translations = {
  ...
  'answerQuestions.error.deleteFailed': 'Échec de suppression de la réponse',
  'answerQuestions.edit': 'Modifier',
  'answerQuestions.delete': 'Supprimer',
  'answerQuestions.editAnswer': 'Modifier la Réponse',
  'answerQuestions.updateAnswer': 'Mettre à Jour la Réponse',
  'answerQuestions.confirmDelete': 'Êtes-vous sûr de vouloir supprimer cette réponse? Cette action ne peut pas être annulée.',
